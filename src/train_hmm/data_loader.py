...
def load_data(num_states, num_observations, train_length):
    dataset_path = LOAD_PATH + f"hmm_train_dataset(state-{num_states}_obs-{num_observations}_length-{train_length}).npz"
