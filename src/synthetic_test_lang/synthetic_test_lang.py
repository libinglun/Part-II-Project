...
if __name__ == "__main__":
    ...
    if args.mode == 'resume':
        ...
        train_sampler(iters, prev_iters, hidden_states, observations, trans_count, emis_count, real_trans_count, noisy_level,
                      alpha=alpha, gamma=gamma, beta=beta, K=K, mode='resume')
